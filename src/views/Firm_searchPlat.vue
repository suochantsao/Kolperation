<template>
    <div class="kolMesBlock">
        ...
        <div class="container trialContent searchfirmBlock">
                ...
                <span class="titleDescrip">請選擇您想要合作的平台媒體</span>

                <ul class="socialBlock contentBlock"
                @click="platSelected">
                    <li 
                       class="socialItem"
                       ...
                       @click="selectPlat('fb')"
                    >
                        <img width="100%" src="../assets/img/facebook.svg" alt="">
                        <span>Facebook</span>
                    </li>
                    ...
                    <li 
                       ...
                       @click="selectPlat('yt')"
                    >
                        <img width="100%" src="../assets/img/youtube.svg" alt="">
                        <span>Youtuber</span>
                    </li>
                </ul>
                <router-link
                  :to="{ name: 'Firm_searchSector', query: { channels: `${fbId}${igId}${ytId}`}}"
                  class="txtBlue"
                >
